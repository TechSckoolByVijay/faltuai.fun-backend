...
# 🔴 IMPORTANT: Load .env BEFORE reading os.getenv
load_dotenv()
...
class Settings:
    ...
    GOOGLE_SEARCH_API: str = os.getenv("GOOGLE_SEARCH_API", "dummy")
    GOOGLE_CSE_ID: str = os.getenv("GOOGLE_CSE_ID", "dummy")
    SERPER_API_KEY: str = os.getenv("SERPER_API_KEY", "dummy")
